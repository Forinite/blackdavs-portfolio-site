        ...
        <div className="w-full h-full col-flex-center">
            <div className="col-flex-center mb-3 ">
                <div className="row-flex-center gap-2 mb-4 ">
                    <a href={contactList[5].link}>
                        <Image
                               className="w-6 aspect-square  rounded-full hover:scale-110 transition-all  "
                               src={contactList[5].image} alt={contactList[5].contact}>
                        </Image>
                    </a>
                    <div className="rounded-full w-12 aspect-square bg-gray-600 col-flex-center mt-4 smooth-expand">
                        <Image className="rounded-full w-11 aspect-square" src={profilePicUrl} alt="Profile" />
                    </div>
                    <a href={contactList[4].link}>
                        <Image
                            className="w-6 aspect-square  rounded-full hover:scale-110 transition-all"
            ...
            <div className="row-flex-center gap-3 mt-2">
                {contactList.map((item, index) => (
                    (index <= 3 && <a key={index} href={item.link}>
                        <Image key={index}
